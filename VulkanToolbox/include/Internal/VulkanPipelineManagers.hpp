...
namespace vkt
{
	...
	{
		ComputePipelineManager(VulkanObjectManager& _vom, vk::PipelineLayoutCreateInfo pipelineLayoutCreateInfo, const char* shaderPath)
		: vom(_vom)
		{
	...
	{
		GraphicsPipelineManager(VulkanObjectManager& _vom,
